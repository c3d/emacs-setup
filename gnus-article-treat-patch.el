...
(set-face-attribute 'ft-gnus-commit-message nil :foreground "darkblue")
...
(set-face-attribute 'ft-gnus-comment1 nil :foreground "gray40")
(make-face 'ft-gnus-comment2)
(set-face-attribute 'ft-gnus-comment2 nil :foreground "gray50")
(make-face 'ft-gnus-comment3)
(set-face-attribute 'ft-gnus-comment3 nil :foreground "gray60")
(make-face 'ft-gnus-comment4)
(set-face-attribute 'ft-gnus-comment4 nil :foreground "gray70")
