...
(define-key ctl-o-map "f" 'manyfindgrep)
...
(define-key ctl-o-map "\C-g" 'manygrep-git)
...
(define-key ctl-o-map "\C-r" 'insert-reviewed-by)
(define-key ctl-o-map "\C-s" 'git-status)
