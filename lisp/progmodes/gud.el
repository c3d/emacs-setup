...
;; debugger). Christophe de Dinechin added support for lldb based on
;; initial work from llvm.org.
  ...
  '(([help]     "Info (debugger)" . gud-goto-info)
    ([tooltips] menu-item "Show GUD tooltips" gud-tooltip-mode
		  ...
		  :visible (memq gud-minor-mode
				'(gdbmi guiler dbx sdb xdb pdb lldb))
	          :button (:toggle . gud-tooltip-mode))
    ([refresh]	"Refresh" . gud-refresh)
    ([run]	menu-item "Run" gud-run
                  :enable (not gud-running)
		  :visible (or (memq gud-minor-mode '(gdb dbx jdb lldb))
			       (and (eq gud-minor-mode 'gdbmi)
    ...
    ([up]	menu-item "Up Stack" gud-up
		  :enable (not gud-running)
		  :visible (memq gud-minor-mode
				 '(gdbmi gdb guiler dbx xdb jdb pdb lldb)))
    ...
    ([print*]	menu-item (if (eq gud-minor-mode 'jdb)
			    ...
			    "Print Dereference") gud-pstar
                  :enable (not gud-running)
		  :visible (memq gud-minor-mode '(gdbmi gdb jdb lldb)))
    ...
    ([finish]	menu-item "Finish Function" gud-finish
                  :enable (not gud-running)
		  :visible (memq gud-minor-mode
				 '(gdbmi gdb guiler xdb jdb pdb lldb)))
    ([stepi]	menu-item "Step Instruction" gud-stepi
                  :enable (not gud-running)
		  :visible (memq gud-minor-mode '(gdbmi gdb dbx lldb)))
...
(easy-mmode-defmap gud-minor-mode-map
  (append
   ...
   (unless window-system
	...
	:visible (memq gud-minor-mode '(gdbmi gdb dbx jdb lldb)))
